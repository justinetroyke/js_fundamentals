...
'Beecher, Henry', 'Beethoven, Ludwig', 'Benenson, Peter', 'Begin, Menachem', 
'Belloc, Hilaire', 'Bellow, Saul', 'Benchley, Robert', 'Ben-Gurion, David', 'Benjamin, Walter',
'Benn, Tony', 'Bennington, Chester', 'Benson, Leana', 'Bent, Silas', 'Bentsen, Lloyd', 'Berger, Ric',
'Bergman, Ingmar', 'Berio, Luciano', 'Berle, Milton', 'Berlin, Irving', 'Berne, Eric', 'Bernhard, Sandra', 
...
const comments = [
    ...
    { text: 'NNice nice nice!', id: 542328 }    
];
